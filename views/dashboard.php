<?php
    ...
    session_start(); // Start the session, so we can access any session data if needed (like user login info)

    require "../classes/User.php"; // Include the User class file so we can use the User class and its method

    // Step 1: Create a new User object (an instance of the User class)
    $user_obj = new User;

    // Step 2: Call the getAllUsers() method on the User object
    // This method retrieves all user information from the database and stores it in the $all_users variable
